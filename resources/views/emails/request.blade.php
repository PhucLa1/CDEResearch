...
<body>
    <h1>CDE Rearsch</h1>
    <h2>Hi {{ $data['userReceive']->name }}</h2>
    <p>Bạn được mời tham gia dự án {{ $data['project']->ProjectName }} bởi {{ $data['userSend']->name }}
        . Bạn có thể đồng ý tham gia bằng cách nhấn vào nút đồng ý dưới đây
    </p>
